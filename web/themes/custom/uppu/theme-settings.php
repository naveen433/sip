...
function uppu_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  ...
  // Input submit button.
  $form['settings']['general']['uppu_submit_button'] = [
    '#type' => 'checkbox',
    '#title' => t('Convert input submit to button element'),
    '#default_value' => theme_get_setting('uppu_submit_button'),
  ...
  // Icons
  $form['fonts_and_icons']['uppu_icons'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use icons'),
    '#description' => t('Checking this will add icons to certain buttons and links.'),
    '#default_value' => theme_get_setting('uppu_icons')
  );
